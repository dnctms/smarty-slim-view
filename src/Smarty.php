...
class Smarty implements \ArrayAccess
{
     ...
     * @throws SmartyException
     */
    public function fetch($template, $data = [], $cache_id = null, $compile_id = null, $parent = null)
    {
     ...
     * @throws SmartyException
     */
    public function render(ResponseInterface $response, $template, $data = [], $cache_id = null, $compile_id = null, $parent = null)
    {
        $response->getBody()->write($this->fetch($template, $data, $cache_id, $compile_id, $parent));
